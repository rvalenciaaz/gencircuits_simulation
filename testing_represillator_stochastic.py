...
# Load the C library
c_lib = ctypes.CDLL('./libstochasticRepressilator.so')
num_points = 1000
...
plt.tight_layout()
#plt.show()
plt.savefig("repressilator_variables_stochastic.jpg", bbox_inches="tight", dpi=300)
plt.savefig("repressilator_variables_stochastic.png", bbox_inches="tight", dpi=300, transparent=True)
